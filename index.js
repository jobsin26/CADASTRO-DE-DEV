...
//Função para criar um input (selecionar varios ctrl + shift + L)
...
//Agora vamos chamar variáveis globais para dar a intereção do input name
...
//agora vamos criar os eventos para os novos campos no formulário
...
addTechBtn.addEventListener('click', function (ev) {
    ...
    const techNameLabel = createLabel('\nNome: ', 'techName-' + rowIndex)
